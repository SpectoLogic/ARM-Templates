...
Param(
    ...
    [string] $ResourceGroupName = 'UbuntoXRDPVSCode',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = '..\Templates\UbuntuVSCode.json',
    [string] $TemplateParametersFile = '..\Templates\UbuntuVSCode.parameters.json',
